 ...
 */
public abstract class CreateRequestProductAbstract extends SvrProcess
{
	/** Process Value 	*/
	private static final String VALUE = "CreateRequestProduct";
	/** Process Name 	*/
	private static final String NAME = "CreateRequestProduct";
	/** Process Id 	*/
	private static final int ID = 3000357;
 
	/**	Parameter Name for IsMandatory	*/
	public static final String IsMandatory = "IsMandatory";
	/**	Parameter Name for ValidFrom	*/
	public static final String ValidFrom = "ValidFrom";

	/**	Parameter Value for isMandatory	*/
	private boolean isMandatory;
	/**	Parameter Value for validfrom	*/
	...
	/**	 Getter Parameter Value for validfrom	*/
