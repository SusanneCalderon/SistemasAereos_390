...
public abstract class Import_ProductPriceRateFromSBAbstract extends SvrProcess
{
	...
	/** Process Name 	*/
	private static final String NAME = "Import_ProductPriceRate";
	/** Process Id 	*/
	...
	/**	Parameter Name for isOnlyRecord_ID	*/
	public static final String isOnlyRecord_ID = "isOnlyRecord_ID";
	...
	/**	Parameter Value for isisOnlyRecordID	*/
	private boolean isisOnlyRecordID;
	...
	protected void prepare()
	{
		...
		isisOnlyRecordID = getParameterAsBoolean(isOnlyRecord_ID);
	}
	...
	/**	 Getter Parameter Value for isisOnlyRecordID	*/
	protected boolean isisOnlyRecordID() {
		return isisOnlyRecordID;
	}
