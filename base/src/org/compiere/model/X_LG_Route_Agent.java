...
/** Generated Model for LG_Route_Agent
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0RC - $Id$ */
public class X_LG_Route_Agent extends PO implements I_LG_Route_Agent, I_Persistent 
{
    ...
    public X_LG_Route_Agent (Properties ctx, int LG_Route_Agent_ID, String trxName)
    {
      super (ctx, LG_Route_Agent_ID, trxName);
      /** if (LG_Route_Agent_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_LG_Route_Agent (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LG_Route_Agent[")
