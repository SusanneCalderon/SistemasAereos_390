		...
		boolean multiSelection, boolean saveResult, String whereClause)
	{
		...
		if (tableName.equals("C_BPartner"))
			...
			info = new InfoAssignment (frame, modal, windowNo, record_id, value,
					multiSelection, saveResult, whereClause);
		else if (tableName.equals("LG_Route"))
			info = new InfoRoute(frame, modal, windowNo, record_id, value,
					multiSelection, saveResult, whereClause);
		else if (tableName.equals("LG_ProductPriceRate"))
			info = new InfoPriceRate(frame, modal, windowNo, record_id, value,
					multiSelection, saveResult, whereClause);
		else
